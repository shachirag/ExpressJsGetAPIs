...
app.get('/protein', (req, res) => {
    ...
    res.json(proteinFoods);
})

app.get('/calorie-above-100', (req, res) => {
    const aboveCalorieFoods = foodData.filter(food => food.category > 100); 
    res.json(aboveCalorieFoods);
})

app.get('/calorie-above-100', (req, res) => {
    const above100CalorieFoods = foodData.filter(food => food.calorie > 100);
    res.json(above100CalorieFoods);
  });
  
  app.get('/calorie-below-100', (req, res) => {
    const below100CalorieFoods = foodData.filter(food => food.calorie < 100);
    res.json(below100CalorieFoods);
  });
